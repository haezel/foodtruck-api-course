...
export default({ config, db }) => {
     ...
     api.delete('/:id', authenticate, (req, res) => {
          FoodTruck.remove({
               ...
               Review.remove({
                    ...
                    res.send({message: "Food truck and associated reviews successfully removed."});
               });
          });
     });
     ...
     // retieve all reviews for a specific food truck
     // 'v1/foodtruck/reviews/:id' - READ ALL
     api.get('/reviews/:id', (req, res) => {
          //find all the reviews that have the foodtruck set to the id passed in
